...
const RU: Dictionary = {
  ...
  'against the same month last year': 'к тому же месяцу год назад',
  'Best of the year': 'Рекорды года',
  'Weekdays': 'Дни недели',
  'Weekday': 'День недели',
  ...
  'Which shift brings the money, and how many hours it takes.': 'Какая смена приносит деньги и сколько часов на это уходит.',
  'A year of it': 'За год',
  'All events': 'Все события',
  'An ordinary day': 'Обычный день',
  'Category': 'Категория',
  'Charges': 'Списания',
  'Enough for': 'Хватит на',
  'Every day with a record on it, averaged — the figure the forecast walks the month with.': 'Среднее по всем дням, о которых есть запись, — та самая величина, с которой прогноз идёт по месяцу.',
  'Fewer events': 'Свернуть',
  'Forecast': 'Прогноз',
  'Money in': 'Приход',
  'Nothing named is due in the next thirty days.': 'В следующие тридцать дней ничего названного не ожидается.',
  'Peak': 'Пик',
  'Share of the month': 'Доля',
  'Tap a category for the shops in it': 'Нажмите на категорию — покажет места',
  'Upcoming': 'Предстоящие',
  'Volume': 'Объём',
  'a question, not a finding': 'вопрос, а не вывод',
  'an average over three months': 'среднее за три месяца',
  'most often first': 'чаще всего — сверху',
  'not enough statement to divide': 'выписки не хватает, чтобы разделить',
