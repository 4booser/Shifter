...
const UK: Dictionary = {
  ...
  /* Фразы редизайна «Статистики», «Твоего года» и «Банка». */
  'against the same month last year': 'до того ж місяця торік',
  'Best of the year': 'Рекорди року',
  'Weekdays': 'Дні тижня',
  'Weekday': 'День тижня',
  ...
  'Which shift brings the money, and how many hours it takes.': 'Яка зміна приносить гроші й скільки годин на це йде.',
  'A year of it': 'За рік',
  'All events': 'Усі події',
  'An ordinary day': 'Звичайний день',
  'Category': 'Категорія',
  'Charges': 'Списання',
  'Enough for': 'Вистачить на',
  'Every day with a record on it, averaged — the figure the forecast walks the month with.': 'Середнє по всіх днях, про які є запис, — та сама величина, з якою прогноз іде по місяцю.',
  'Fewer events': 'Згорнути',
  'Forecast': 'Прогноз',
  'Money in': 'Надходження',
  'Nothing named is due in the next thirty days.': 'У наступні тридцять днів нічого названого не очікується.',
  'Peak': 'Пік',
  'Share of the month': 'Частка',
  'Tap a category for the shops in it': 'Натисніть на категорію — покаже місця',
  'Upcoming': 'Найближчі',
  'Volume': 'Обсяг',
  'a question, not a finding': 'питання, а не висновок',
  'an average over three months': 'середнє за три місяці',
  'most often first': 'найчастіше — згори',
  'not enough statement to divide': 'виписки не досить, щоб поділити',
