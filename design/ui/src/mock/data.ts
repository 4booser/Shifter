 ...
 * Итоги месяца.
 *
 * Все до одного посчитаны по сетке выше, а не выдуманы отдельно. Раньше
 * здесь стояло «17 смен, 137 часов, ₴24 700», пока в самом календаре лежали
 * двадцать смен на ₴38 770 — и любой, кто взялся бы сложить клетки, поймал
 * бы приложение на вранье в первой же строке.
 */
 ...
 * Подработки.
 *
 * `worth` — не украшение, а частное: сколько выходит в час против вашей
 * ставки в ₴200. Сравнивать надо со ставкой, а не с эффективным часом:
 * эффективный включает чаевые, а сколько чаевых будет на чужой смене, не
 * знает никто.
 */
export const GIGS = [
