...
/** The arithmetic behind the report visualisations, kept pure: a waterfall that must sum exactly to what the… */
...
/** How the period's money assembled itself: each source stacks up, each deduction steps down, with a landing at… */
...
/** The week as seven horizontal bands: when each weekday usually starts and ends, how often it happens, what its… */
