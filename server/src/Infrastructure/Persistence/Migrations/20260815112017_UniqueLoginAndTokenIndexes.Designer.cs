...
namespace Shifter.src.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260815112017_UniqueLoginAndTokenIndexes")]
    partial class UniqueLoginAndTokenIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DayShift", b =>
                {
            ...
            modelBuilder.Entity("DayShift", b =>
                {
                    b.HasOne("Shifter.Domain.Entities.Day", null)
                        .WithMany()
                        .HasForeignKey("DaysId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Shifter.Domain.Entities.Shift", null)
                        .WithMany()
