...
public static class DependencyInjection
{
        ...
        bool allowLocalKey = false)
    {
        ...
        services.AddScoped<Shifter.Application.Features.business.Services.DraftPricer>();
        ...
        services.AddScoped<Shifter.Application.Features.Gigs.CityCompareService>();
        services.AddScoped<Shifter.Application.Features.Health.RecordsHealthService>();
