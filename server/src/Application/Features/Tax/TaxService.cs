...
/// <summary>The person's own tax arrangement, and what their own year adds up to under it.</summary>
public sealed class TaxService
{
    ...
    /// <summary>The year read against the profile.</summary>
    ...
    /// <summary>What the shifts came to over the year.</summary>
