...
const FORMS: Record<string, Record<Language, string[]>> = {
  ...
  expenses: { en: ['expense', 'expenses'], ru: ['трата', 'траты', 'трат'], uk: ['витрата', 'витрати', 'витрат'] },
  times: { en: ['time', 'times'], ru: ['раз', 'раза', 'раз'], uk: ['раз', 'рази', 'разів'] },
  units: { en: ['unit', 'units'], ru: ['штука', 'штуки', 'штук'], uk: ['штука', 'штуки', 'штук'] },
  ...
  places: { en: ['place', 'places'], ru: ['место', 'места', 'мест'], uk: ['місце', 'місця', 'місць'] },
  ...
  reviews: { en: ['review', 'reviews'], ru: ['отзыв', 'отзыва', 'отзывов'], uk: ['відгук', 'відгуки', 'відгуків'] },
  'events-n': { en: ['event', 'events'], ru: ['событие', 'события', 'событий'], uk: ['подія', 'події', 'подій'] },
};
