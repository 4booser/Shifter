...
export const SHIFTS = [
  { name: 'Вечер', symbol: '🍸', time: '17:00–01:00', hours: '8,5 ч', pay: '₴200 в час', place: 'Бар «Сова»', extra: 'пул 15%' },
  { name: 'День', symbol: '☕️', time: '09:00–17:00', hours: '7,5 ч', pay: '₴150 в час', place: 'Бар «Сова»' },
  { name: 'Банкет', symbol: '🥂', time: '18:00–23:00', hours: '5,0 ч', pay: '₴1 400 за смену', place: 'Ресторан «Дым»' },
];
...
export const PAYOUTS = [
  { place: 'Бар «Сова»', span: '16–30 июня', due: 'выплата 5 июля', amount: '₴9 260', state: 'Задержка', late: '+57 дн.' },
  { place: 'Бар «Сова»', span: '1–15 июля', due: 'выплата 20 июля', amount: '₴17 274', state: 'Задержка', late: '+42 дн.' },
  { place: 'Бар «Сова»', span: '16–31 июля', due: 'выплата 5 авг.', amount: '₴18 437', state: 'Задержка', late: '+26 дн.' },
  { place: 'Ресторан «Дым»', span: '1–15 августа', due: 'выплата 20 авг.', amount: '₴17 808', state: 'Пришло' },
  { place: 'Бар «Сова»', span: '16–31 августа', due: 'выплата 5 сент.', amount: '₴16 590', state: 'Идёт' },
];
...
export const GIGS = [
  { title: 'Бармен на вечер пятницы', venue: 'Бар «Хмель»', city: 'Днепр', when: '5 сентября · 16:00–23:00', pay: '₴250', per: 'в час', worth: '+6% к вашему часу', urgent: true },
  { title: 'Повар горячего цеха на банкет', venue: 'Ресторан «Дым»', city: 'Киев', when: '5 сентября · 12:00–23:00', pay: '₴2 800', per: 'за смену', worth: '+7% к вашему часу' },
  { title: 'Бариста на выходные', venue: 'Кофейня «Тчк»', city: 'Днепр', when: '6 сентября · 08:00–16:00', pay: '₴180', per: 'в час', worth: '−12% к вашему часу', worse: true },
  { title: 'Хостес на открытие', venue: 'Terrace 42', city: 'Днепр', when: '7 сентября · 18:00–02:00', pay: '₴1 900', per: 'за смену', worth: '+2% к вашему часу' },
];
