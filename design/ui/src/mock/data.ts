...
export const TILES = [
  { said: 'Твой час', num: '₴238', foot: '163 часа за месяц' },
  { said: 'Чаевые', num: '₴7 700', foot: '20% заработка · ₴385 на смену' },
  { said: 'Лучший день', num: '₴2 470', foot: '1 августа, суббота' },
  { said: 'Средний день', num: '₴1 939', foot: '20 смен' },
  { said: 'Ночные часы', num: '62', foot: '38% всех часов' },
  { said: 'Удержано', num: '₴8 030', foot: 'налог, котёл и питание', tone: 'bad' as const },
  { said: 'Подряд', num: '5', foot: 'дней без выходного' },
  { said: 'Гостей', num: '990', foot: '₴39 с гостя' },
];
...
/** Подработки. */
export const GIGS = [
  { title: 'Бармен на вечер пятницы', venue: 'Бар «Хмель»', city: 'Днепр', when: '5 сентября · 16:00–23:00', pay: '₴250', per: 'в час', hourly: '₴250 в час', worth: '+25% к вашей ставке', urgent: true },
  { title: 'Повар горячего цеха на банкет', venue: 'Ресторан «Веранда»', city: 'Днепр', when: '5 сентября · 12:00–23:00', pay: '₴2 800', per: 'за смену', hourly: '11 часов — ₴254 в час', worth: '+27% к вашей ставке' },
  { title: 'Бариста на выходные', venue: 'Кофейня «Тчк»', city: 'Днепр', when: '6 сентября · 08:00–16:00', pay: '₴140', per: 'в час', hourly: '₴140 в час', worth: '−30% к вашей ставке', worse: true },
  { title: 'Хостес на открытие', venue: 'Terrace 42', city: 'Днепр', when: '7 сентября · 18:00–02:00', pay: '₴1 900', per: 'за смену', hourly: '8 часов — ₴237 в час', worth: '+19% к вашей ставке' },
];
