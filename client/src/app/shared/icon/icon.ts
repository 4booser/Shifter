...
const PATHS: Record<IconName, string[]> = {
  ...
  users: [
    'M9 11.5a3.5 3.5 0 100-7 3.5 3.5 0 000 7z',
    'M2.5 20c0-3.3 2.9-5.5 6.5-5.5s6.5 2.2 6.5 5.5',
    'M16 5.2a3.2 3.2 0 010 6.1',
    'M17.5 14.8c2.4.6 4 2.3 4 4.7',
  ],
  search: ['M11 4a7 7 0 100 14 7 7 0 000-14z', 'M20 20l-4-4'],
  user: ['M12 12a4 4 0 100-8 4 4 0 000 8z', 'M4.5 20.5c0-3.9 3.4-6.5 7.5-6.5s7.5 2.6 7.5 6.5'],
